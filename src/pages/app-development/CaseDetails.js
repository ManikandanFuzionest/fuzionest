...
import imgCase1 from '../../assets/image/jpeg/appBanner.png';
import imgCase2 from '../../assets/image/jpeg/Mobile-Application.jpg';
import imgCase3 from '../../assets/image/jpeg/Mobile-App-1024x1024.jpg';
    ...
    <Section className="position-relative" borderBottom="1px solid #eae9f2;">
      <Container>
        ...
        <Row>
          ...
          <Col lg="6">
            <Box>
              <img src={imgCase3} alt="" style={{ height: '458px' }} className="img-fluid" />
            </Box>
          </Col>
        </Row>
        <Row className="mt-5">
